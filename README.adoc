= STATE
image:https://img.shields.io/badge/license-PMPL--1.0-blue.svg[Palimpsest-MPL-1.0,link="https://github.com/hyperpolymath/palimpsest-license"] 
...
Standard Guile functions for querying state:

[source,scheme]
----
(get-completion-percentage state)  ; Overall completion %
(get-blockers state)               ; All blockers across projects
(get-milestone state "v0.3")       ; Specific milestone info
(project-blocked? state "Name")    ; Check if project is blocked
----
